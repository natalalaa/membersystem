...
Du er tilmeldt KBHFF, <?= $divisioninfo['name']?> -
<a href="/afdelingsinfo/grupper/<?= $divisioninfo['division']?>">n&oslash;glepersoner i <?= $divisioninfo['name']?></a><br>
<?
echo ('<span class="note"><a href="/minside/nyhedsbrev/'.$newsletter['0']['uid'].'"><i>'.$newsletter['0']['date'] . '</i>: '.$newsletter['0']['subject'].'<br>'.substr($newsletter['0']['content'],0,160) . '[...] l&aelig;s mere</a></span>');
?>
<br>
<?php if (is_array($pickups)):?>
Der er udlevering af varer:
<?php foreach ($pickups as $item):?>

<?php echo $item['pickupdate'];?> 
